  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div  class="alert alert-success alert-dismissible fade show" role="alert" width=>
          ...
          <form action="{{url('upload_doctor')}}" method="POST" enctype="multipart/form-data">
            ...
            <div style="padding:15px;">
              ...
              <select style="color: black; width: 200px;" name="speciality" required="">
                ...
                <option value="skin">Dermetology</option>
                <option value="heart">Cardiology</option>
                <option value="eye">Prediation</option>
                <option value="nose">Nutrition</option>
              </select>
            </div>
            <div style="padding:15px;">
              <label>Room No</label>
